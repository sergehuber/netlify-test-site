...
;
//_modules_dx-base-demo-core_javascript_scrollmagic_ScrollMagic.js_1539771156047.min.js
/*!
...
//_modules_dx-base-demo-core_javascript_custom_parallaxSlider.js_1539771156047.min.js
$(function(){var a=new ScrollMagic.Controller({globalSceneOptions:{triggerHook:"onLeave"}});var c=document.querySelectorAll("section.parallaxPanel");for(var b=0;b<c.length;b++){if(c[b].className.indexOf("noeffect")<0){new ScrollMagic.Scene({triggerElement:c[b]}).setPin(c[b]).addTo(a)}else{new ScrollMagic.Scene({triggerElement:c[b+1]}).setPin(c[b]).addTo(a)}}});;
