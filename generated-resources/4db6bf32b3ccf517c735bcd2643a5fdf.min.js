...
;
//_modules_dx-base-demo-core_javascript_masterslider_masterslider.min.js_1539771156047.min.js
/*! 
...
;
//_modules_dx-base-demo-core_javascript_master-slider-fw.js_1539771156047.min.js
var MSfullWidth=function(){return{initMSfullWidth:function(g,f,d,e,b){var c=new MasterSlider();var a=false;if(parseInt(b)>1){c.control("arrows");c.control("bullets",{autohide:false});a=true}c.setup(g,{width:1024,height:600,fullwidth:true,centerControls:false,speed:18,view:f,mouse:a,loop:true,layout:d,autoplay:e})}}}();;
//_modules_dx-base-demo-components_javascript_custom_slider.js_1532016758318.min.js
$(window).load(function(){var b=document.querySelectorAll(".master-slider-jahia");for(var a=0;a<b.length;a++){MSfullWidth.initMSfullWidth(b[a].id,b[a].getAttribute("transition"),b[a].getAttribute("layout"),b[a].getAttribute("autoplay")=="true",b[a].getAttribute("panelcount"))}});;
//_modules_dx-base-demo-components_javascript_custom_jahiademo-custom.js_1532016758318.min.js
function GetURLParameter(a){var d=window.location.search.substring(1);var c=d.split("&");for(var b=0;b<c.length;b++){var e=c[b].split("=");if(e[0]==a){return e[1]}}}function updateQueryStringParameter(c,a,d){var b=new RegExp("([?&])"+a+"=.*?(&|$)","i");var e=c.indexOf("?")!==-1?"&":"?";if(c.match(b)){return c.replace(b,"$1"+a+"="+d+"$2")}else{return c+e+a+"="+d}}function initializeActiveTab(a,c,b){$(a).each(function(){var d=GetURLParameter(c+$(this).attr("uuid"));if(d==null){d=b}if(!$(this).find(".active")[0]){$(this).find("."+d).addClass("active")}})};;
//_modules_dx-base-demo-components_javascript_custom_eventTabs.js_1532016758318.min.js
function activeEventViewTab(){initializeActiveTab(".eventTabs","eventTab","upcoming")}function activateEventTabAjax(){$(".eventTabItem").click(function(){var a=$(this).attr("view");var b=$(this).closest(".eventTabs");var c=updateQueryStringParameter(window.location.href,"eventTab"+b.attr("uuid"),a);if(b.attr("disableAjax")=="true"){window.location.replace(c)}else{history.pushState(null,null,c);b.parent().load(b.attr("url")+".ajax?eventTab"+b.attr("uuid")+"="+a+" #"+b.attr("id"),function(){activateEventTabAjax();activeEventViewTab()})}})}$(document).ready(function(){activeEventViewTab();activateEventTabAjax()});;
//_modules_dx-base-demo-components_javascript_custom_pressSearch.js_1532016758318.min.js
function activePressSearchTab(){initializeActiveTab(".pressSearch","yearTab","defaultYear")}function activatePressSearchTabAjax(){$(".pressTabItem").click(function(){var a=$(this).attr("view");var b=$(this).closest(".pressSearch");var c=updateQueryStringParameter(window.location.href,"yearTab"+b.attr("uuid"),a);if(b.attr("disableAjax")=="true"){window.location.replace(c)}else{history.pushState(null,null,c);b.parent().load(b.attr("url")+".ajax?yearTab"+b.attr("uuid")+"="+a+" #"+b.attr("id"),function(){activatePressSearchTabAjax();activePressSearchTab()})}})}$(document).ready(function(){activePressSearchTab();activatePressSearchTabAjax()});;
//_modules_assets_javascript_video.js_1532003505766.min.js
...
//_modules_dx-base-demo-core_javascript_owl.carousel.js_1539771156047.min.js
